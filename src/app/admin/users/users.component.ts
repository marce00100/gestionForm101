  ...
  user = function () {
    $(function () {
          ...
          sections: [
            {
              ...
              fields: [
                ...
                },
                {
                  ...
                  required: true, grid_column_span: 1, class: { group: 'has-primary', label: 'mbn ptn quest-label', icon: '', input: 'quest-input-label p5' },
                },
                {
              ...
              if (field.type == 'text' || field.type == 'number' || field.type == 'date' || field.type == 'password' || field.type == 'email') {
                htmlFields += /*html*/`
                                        ...
                                        <div class="form-group_      ${field.class.group || ''}  ">
                                            <label  class="col-xs-11 ${field.grid_column_span ? 'col-md-3' : 'col-md-4'} control-label ${field.class.label || ''}" for="${field.field}"
                                            style="top:15px">${field.label}</label>
      ...
      let conT:any = {
        ...
        nuevo: function () {
          $("#tituloModal span").html(`Agregar usuario`);
        ...
        editar: function () {
          ...
          if (rowSelected.length > 0) {
            ...
            conT.setData(rowSel);
            $("#tituloModal span").html(`Modificar Usuario`);
            funs.showModal();
          }
          else {
